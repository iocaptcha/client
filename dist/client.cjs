...
function render$1(element) {
    ...
    const widget = new Widget(exports.WidgetType.Iosec, formfield, widgetid, iframe, element);
    iframe.onload = () => {
        send(iframe, {
...
function render(element) {
    ...
    const widget = new Widget(exports.WidgetType.Iocaptcha, formfield, widgetid, iframe, element);
    iframe.onload = () => {
        send(iframe, {
            method: 'set_pubkey',
            pubkey
...
exports.CaptchaOptions = CaptchaOptions;
exports.Iocaptcha = Iocaptcha;
exports.Iosec = Iosec;
exports.IosecOptions = IosecOptions;
exports.Widget = Widget;
exports.scan_and_render = scan_and_render;
